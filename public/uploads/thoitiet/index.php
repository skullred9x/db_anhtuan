...
<table width="<?php if($_GET['size']){echo $_GET['size'].'px';} else {echo '280px';}?>" cellspacing="0" cellpadding="0" border="0" class="bg_tb">
    ...
    <td  valign="top" style="padding:5px">
        ...
        <table width="120px" border="0" cellspacing="0" cellpadding="0">
          <tr><td><a href="#" target="_blank"><img src="images/cloud.png" border="0"  width="25px" style="vertical-align:middle" alt="Cập nhật thời tiết" title="Cập nhật thời tiết,tỷ giá,giá vàng từ vnexpress" /></a> <b>Thời tiết</b></td>
          </tr>
    ...
    <td style="padding:5px">
         ...
         <tr><td colspan="2">
          <a href="#" target="_blank"><img title="Cập nhật thời tiết,tỷ giá,giá vàng từ vnexpress"  border="0" src="images/money.png" style="vertical-align:middle" width="25px" alt="Giá vàng" />  </a>
               <b>Giá vàng</b>
          </td></tr>
         <tr><td>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td colspan="2">
                                           <a href="#" target="_blank"> <img src="images/circle-chart.png" style="vertical-align:middle" border="0" title="Cập nhật thời tiết,tỷ giá,giá vàng từ vnexpress"  alt="Tỷ giá" />  </a>
                                      <b>Tỷ giá</b>                              </td>
                                </tr>
                                <tr>
...
<table width="<?php if(!empty($_GET['size']) && $_GET['size']){echo $_GET['size'].'px';} else {echo '280px';}?>" cellspacing="0" cellpadding="0" border="0" class="bg_tb">
  <tr>
    <td rowspan="2" valign="top" style="<?php if(!empty($_GET['w']) && $_GET['w']==1 and (($_GET['g']==1) or ($_GET['r']==1))) echo 'border-right:1px dashed #ccc;';?>padding:5px">
	   ...
	   ?>
        <table width="120px" border="0" cellspacing="0" cellpadding="0">
          <tr><td><a href="#" target="_blank"><img title="Cập nhật thời tiết,tỷ giá,giá vàng từ vnexpress"  src="images/cloud.png" border="0"  width="25px" style="vertical-align:middle" alt="Cập nhật thời tiết" /></a> <b>Thời tiết</b></td>
          </tr>
             <form name="form1" method="post">
                <tr height="20px">
                    <td>
